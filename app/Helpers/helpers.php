...
class Helper
{
    ...
    public static function authLogo(){
        return '<img src="'. Helper::logo() .'" ><h2 class="brand-text text-primary ms-1 mt-1">'. env('APP_NAME') .'</h2>';
    }

    public static function appLogo(){
        return '<span class="brand-logo"><img src="'. Helper::logo() .'" ></span><h2 class="brand-text text-primary">'. env('APP_NAME') .'</h2>';
    }
}
